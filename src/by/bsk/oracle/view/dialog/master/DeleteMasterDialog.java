...
public class DeleteMasterDialog extends JDialog {
	...
	public DeleteMasterDialog(JTable jTable, DefaultTableModel tModel) {
		this.jTable = jTable;
		this.tModel = tModel;
		initComponents();
	}
	...
	private void registerListeners() {
		...
		ActionListener deleteUser = new DeleteMasterCommand(jTable, tModel);
