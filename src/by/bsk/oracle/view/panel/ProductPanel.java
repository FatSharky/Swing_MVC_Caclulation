...
public class ProductPanel extends JPanel {
	...
	private void createPanel(User user) {
		...
		bAddMaster.setIcon(new ImageIcon(ProductPanel.class.getResource("/icon/add_obj.gif")));
		menuBar.add(bAddMaster);

		JButton bUpdateMaster = new JButton("");
		bUpdateMaster.setIcon(new ImageIcon(ProductPanel.class.getResource("/icon/edit.gif")));
		menuBar.add(bUpdateMaster);

		JButton bDeleteMaster = new JButton("");

		bDeleteMaster.setIcon(new ImageIcon(ProductPanel.class.getResource("/icon/remove.gif")));
		...
		JLabel lInfoPriceCategories = new JLabel("sdaasdsa"
				+ "\u041D\u0430\u0446\u0435\u043D\u043E\u0447\u043D\u044B\u0435 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438");
		lInfoPriceCategories.setBounds(76, 39, 152, 16);
		add(lInfoPriceCategories);

		JLabel lInfoStructuralUnits = new JLabel("sdaasdsa"
		...
		structUnitCB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(item == null)) {
					...
					tModel = ShowJTable.productTable(value);
